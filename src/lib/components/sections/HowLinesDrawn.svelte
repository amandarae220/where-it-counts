...
<section class="section how-lines-drawn">
  <div class="prose">
    ...
    <p>
      For forty years, politicians have been drawing their own district maps.
      They sorted red voters and blue voters into separate corners, locking
      in election outcomes that favor them and protect their path to becoming
      a career politician.
    </p>
    <p>
      That's gerrymandering. And it worked. But gerrymandering didn't create
